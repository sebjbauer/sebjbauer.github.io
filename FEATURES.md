...
| **Triathlon** | On summer days (or from 18 °C in other seasons), dry and not frozen, every 3 to 6 minutes: an athlete in an orange cap stands at the end of the jetty, raises their arms and dives in, swims across the lake, then the cyclist rides back through the valley, then a runner with a race bib runs along the road. Click an athlete: "Triathlon: 1.5 km swim, 40 km bike, 10 km run." Terminal: `triathlon` starts a race. |
